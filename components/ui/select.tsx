...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-6 w-full items-center justify-between rounded-md  bg-transparent px-3  text-sm shadow-sm  placeholder:text-neutral-500  focus:ring-neutral-950 disabled:cursor-not-allowed disabled:opacity-50  dark:placeholder:text-neutral-400",
      className
    )}
    {...props}
  >
